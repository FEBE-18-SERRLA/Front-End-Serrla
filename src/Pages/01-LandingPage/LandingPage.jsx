			...
			<main>
				...
				>
					...
					<div className="container ">
						...
						>
							<div
								className={`col-md-6 ${module["hero-section-text"]}`}
							>
								<h1 className="hero-text pw-bold h1">
									Tingkatkan potensi kesenianmu!
								</h1>
								<p className="pw-light">
									Gali minat dan bakatmu bersama Serrla dengan
									pemateri yang handal di bidangnya
								</p>
							...
							<div
								className={`col-md-6 ${module["hero-section-img"]}`}
							>
								<img
									src={Gambar1}
									alt="hero"
					...
					<div className="container">
						<div className="row d-flex align-items-center">
							...
							<div className="col-md-6">
								...
								<p className="pw-light">
									Serrla (Serrum Learning Art) adalah aplikasi
									yang bergerak di bidang pendidikan seni dan
									budaya. Serrla membantu siswa dalam mengenal
									dan mempelajari seni melalui materi dan
									video pembelajaran interaktif oleh pemateri.
								</p>
							</div>
						</div>
					</div>
					...
					<div className="container">
						<div className="row">
							<div className="col-md-12">
								<h2
									className={`${module["list-class-text"]} pw-semibold h2`}
								>
									Gabung Bersama Kami
								</h2>
							</div>
