		...
		<footer className="footer">
			<div className="container">
				<div className="row py-5">
					...
					<div className="col-md-2">
						...
						<ul className="p-0">
							<li className="mt-2 list-decoration-none">
								<Link
									to="/modul?q=Seni%20Rupa"
									className="pw-light nav-link"
								>
									Seni Rupa
								</Link>
							</li>
					...
					<div className="col-md-2">
						<h5 className="footer-text pw-semibold mb-3">
							Tentang Kami
						</h5>
						<ul className="p-0">
							<li className="mt-2">
